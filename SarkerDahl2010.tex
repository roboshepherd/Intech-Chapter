...
From the study of social insects and other biological societies, we can find that two major properties of DOL have been established in literature.
\begin{enumerate}
...
\textbf{Rule 1: Continuous flow of information.} Self-regulatory social systems establish a system-wide continuous minimum flow of information. This should help to maintain at least two states of an agent: i) to receive information about task(s) and ii) to ignore information or doing no task. The up-to-date information should reflect  the changes of the system i.e. it should encode the necessary feedback for the agents.
...
- Pose data of robots,\\
- Communication of task-information message with robots.
...
%%-------------------------------------------------
%We have aggregated the changes in translation motion of all robots over time following an approach similar to task-urgency aggregation as described in Sec. \ref{validation:results}. The robot translation results from both local mode experiments are plotted in Fig. \ref{fig:translation-SC-SD}. In this plot we can see that robot translations also vary over varying task requirements of tasks.\\ 
%-----------------------------------------------------------
